<?php if (!defined('IN_PHPBB')) exit; $this->_tpl_include('ucp_header.html'); $this->_tpl_include('ucp_pm_message_header.html'); if ($this->_rootref['S_DISPLAY_HISTORY'] && ( $this->_rootref['U_VIEW_PREVIOUS_HISTORY'] || $this->_rootref['U_VIEW_NEXT_HISTORY'] )) {  ?>
...
<div id="post-<?php echo (isset($this->_rootref['MESSAGE_ID'])) ? $this->_rootref['MESSAGE_ID'] : ''; ?>" class="panel clearfix post pm-panel-message pm<?php if ($this->_rootref['S_POST_UNAPPROVED'] || $this->_rootref['S_POST_REPORTED']) {  ?> reported<?php } if ($this->_rootref['S_ONLINE']) {  ?> online<?php } ?>">
<div>
