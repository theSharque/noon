<?php if (!defined('IN_PHPBB')) exit; $this->_tpldata['DEFINE']['.']['CA_PAGE'] = 'users'; if ($this->_rootref['S_IN_SEARCH_POPUP']) {  $this->_tpl_include('simple_header.html'); $this->_tpl_include('memberlist_search.html'); ?>
...
<?php } if ($this->_rootref['S_SHOW_GROUP']) {  ?>
	...
	<div class="forumbg forumbg-table">
		...
		<table class="table1" cellspacing="<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_TABLE_SPACING'])) ? $this->_tpldata['DEFINE']['.']['CA_TABLE_SPACING'] : ''; ?>" id="memberlist" width="100%">
		<thead>
		<tr>
			<th class="name"><span class="rank-img"><a href="<?php echo (isset($this->_rootref['U_SORT_RANK'])) ? $this->_rootref['U_SORT_RANK'] : ''; ?>"><?php echo ((isset($this->_rootref['L_RANK'])) ? $this->_rootref['L_RANK'] : ((isset($user->lang['RANK'])) ? $user->lang['RANK'] : '{ RANK }')); ?></a></span><a href="<?php echo (isset($this->_rootref['U_SORT_USERNAME'])) ? $this->_rootref['U_SORT_USERNAME'] : ''; ?>"><?php if ($this->_rootref['S_SHOW_GROUP'] && sizeof($this->_tpldata['memberrow'])) {  echo ((isset($this->_rootref['L_GROUP_LEADER'])) ? $this->_rootref['L_GROUP_LEADER'] : ((isset($user->lang['GROUP_LEADER'])) ? $user->lang['GROUP_LEADER'] : '{ GROUP_LEADER }')); } else { echo ((isset($this->_rootref['L_USERNAME'])) ? $this->_rootref['L_USERNAME'] : ((isset($user->lang['USERNAME'])) ? $user->lang['USERNAME'] : '{ USERNAME }')); } ?></a></th>
...
<div class="forumbg forumbg-table">
	...
	<table class="table1" cellspacing="<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_TABLE_SPACING'])) ? $this->_tpldata['DEFINE']['.']['CA_TABLE_SPACING'] : ''; ?>" width="100%">
	<thead>
	<tr>
	<?php if (! $this->_rootref['S_LEADERS_SET']) {  ?>

		<th class="name"><span class="rank-img"><a href="<?php echo (isset($this->_rootref['U_SORT_RANK'])) ? $this->_rootref['U_SORT_RANK'] : ''; ?>"><?php echo ((isset($this->_rootref['L_RANK'])) ? $this->_rootref['L_RANK'] : ((isset($user->lang['RANK'])) ? $user->lang['RANK'] : '{ RANK }')); ?></a></span><a href="<?php echo (isset($this->_rootref['U_SORT_USERNAME'])) ? $this->_rootref['U_SORT_USERNAME'] : ''; ?>"><?php if ($this->_rootref['S_SHOW_GROUP']) {  echo ((isset($this->_rootref['L_GROUP_MEMBERS'])) ? $this->_rootref['L_GROUP_MEMBERS'] : ((isset($user->lang['GROUP_MEMBERS'])) ? $user->lang['GROUP_MEMBERS'] : '{ GROUP_MEMBERS }')); } else { echo ((isset($this->_rootref['L_USERNAME'])) ? $this->_rootref['L_USERNAME'] : ((isset($user->lang['USERNAME'])) ? $user->lang['USERNAME'] : '{ USERNAME }')); } ?></a></th>
			<th class="posts"><a href="<?php echo (isset($this->_rootref['U_SORT_POSTS'])) ? $this->_rootref['U_SORT_POSTS'] : ''; ?>#memberlist"><?php echo ((isset($this->_rootref['L_POSTS'])) ? $this->_rootref['L_POSTS'] : ((isset($user->lang['POSTS'])) ? $user->lang['POSTS'] : '{ POSTS }')); ?></a></th>
			<th class="info"><a href="<?php echo (isset($this->_rootref['U_SORT_WEBSITE'])) ? $this->_rootref['U_SORT_WEBSITE'] : ''; ?>#memberlist"><?php echo ((isset($this->_rootref['L_WEBSITE'])) ? $this->_rootref['L_WEBSITE'] : ((isset($user->lang['WEBSITE'])) ? $user->lang['WEBSITE'] : '{ WEBSITE }')); ?></a><?php echo ((isset($this->_rootref['L_COMMA_SEPARATOR'])) ? $this->_rootref['L_COMMA_SEPARATOR'] : ((isset($user->lang['COMMA_SEPARATOR'])) ? $user->lang['COMMA_SEPARATOR'] : '{ COMMA_SEPARATOR }')); ?><a href="<?php echo (isset($this->_rootref['U_SORT_LOCATION'])) ? $this->_rootref['U_SORT_LOCATION'] : ''; ?>"><?php echo ((isset($this->_rootref['L_LOCATION'])) ? $this->_rootref['L_LOCATION'] : ((isset($user->lang['LOCATION'])) ? $user->lang['LOCATION'] : '{ LOCATION }')); ?></a></th>
			<th class="joined"><a href="<?php echo (isset($this->_rootref['U_SORT_JOINED'])) ? $this->_rootref['U_SORT_JOINED'] : ''; ?>#memberlist"><?php echo ((isset($this->_rootref['L_JOINED'])) ? $this->_rootref['L_JOINED'] : ((isset($user->lang['JOINED'])) ? $user->lang['JOINED'] : '{ JOINED }')); ?></a></th>
			<?php if ($this->_rootref['U_SORT_ACTIVE']) {  ?><th class="active"><a href="<?php echo (isset($this->_rootref['U_SORT_ACTIVE'])) ? $this->_rootref['U_SORT_ACTIVE'] : ''; ?>#memberlist"><?php echo ((isset($this->_rootref['L_LAST_ACTIVE'])) ? $this->_rootref['L_LAST_ACTIVE'] : ((isset($user->lang['LAST_ACTIVE'])) ? $user->lang['LAST_ACTIVE'] : '{ LAST_ACTIVE }')); ?></a></th><?php } } else if ($this->_rootref['S_SHOW_GROUP']) {  ?>
