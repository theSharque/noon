...
<?php } if ($this->_rootref['S_DISPLAY_POST_INFO']) {  ?>
	...
	<tr>
		<td align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_BEGIN'])) ? $this->_rootref['S_CONTENT_FLOW_BEGIN'] : ''; ?>" valign="top">
			...
			<tr>
				<td width="20" style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_UNREAD_IMG'])) ? $this->_rootref['FOLDER_UNREAD_IMG'] : ''; ?></td>
				<td class="gensmall"><?php echo ((isset($this->_rootref['L_UNREAD_POSTS'])) ? $this->_rootref['L_UNREAD_POSTS'] : ((isset($user->lang['UNREAD_POSTS'])) ? $user->lang['UNREAD_POSTS'] : '{ UNREAD_POSTS }')); ?></td>
				<td>&nbsp;&nbsp;</td>
				<td width="20" style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_IMG'])) ? $this->_rootref['FOLDER_IMG'] : ''; ?></td>
				<td class="gensmall"><?php echo ((isset($this->_rootref['L_NO_UNREAD_POSTS'])) ? $this->_rootref['L_NO_UNREAD_POSTS'] : ((isset($user->lang['NO_UNREAD_POSTS'])) ? $user->lang['NO_UNREAD_POSTS'] : '{ NO_UNREAD_POSTS }')); ?></td>
				<td>&nbsp;&nbsp;</td>
			...
			<tr>
				<td style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_HOT_UNREAD_IMG'])) ? $this->_rootref['FOLDER_HOT_UNREAD_IMG'] : ''; ?></td>
				<td class="gensmall"><?php echo ((isset($this->_rootref['L_UNREAD_POSTS_HOT'])) ? $this->_rootref['L_UNREAD_POSTS_HOT'] : ((isset($user->lang['UNREAD_POSTS_HOT'])) ? $user->lang['UNREAD_POSTS_HOT'] : '{ UNREAD_POSTS_HOT }')); ?></td>
				<td>&nbsp;&nbsp;</td>
				<td style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_HOT_IMG'])) ? $this->_rootref['FOLDER_HOT_IMG'] : ''; ?></td>
				<td class="gensmall"><?php echo ((isset($this->_rootref['L_NO_UNREAD_POSTS_HOT'])) ? $this->_rootref['L_NO_UNREAD_POSTS_HOT'] : ((isset($user->lang['NO_UNREAD_POSTS_HOT'])) ? $user->lang['NO_UNREAD_POSTS_HOT'] : '{ NO_UNREAD_POSTS_HOT }')); ?></td>
				<td>&nbsp;&nbsp;</td>
			...
			<tr>
				<td style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_LOCKED_UNREAD_IMG'])) ? $this->_rootref['FOLDER_LOCKED_UNREAD_IMG'] : ''; ?></td>
				<td class="gensmall"><?php echo ((isset($this->_rootref['L_UNREAD_POSTS_LOCKED'])) ? $this->_rootref['L_UNREAD_POSTS_LOCKED'] : ((isset($user->lang['UNREAD_POSTS_LOCKED'])) ? $user->lang['UNREAD_POSTS_LOCKED'] : '{ UNREAD_POSTS_LOCKED }')); ?></td>
				<td>&nbsp;&nbsp;</td>
				<td style="text-align: center;"><?php echo (isset($this->_rootref['FOLDER_LOCKED_IMG'])) ? $this->_rootref['FOLDER_LOCKED_IMG'] : ''; ?></td>
				<td class="gensmall"><?php echo ((isset($this->_rootref['L_NO_UNREAD_POSTS_LOCKED'])) ? $this->_rootref['L_NO_UNREAD_POSTS_LOCKED'] : ((isset($user->lang['NO_UNREAD_POSTS_LOCKED'])) ? $user->lang['NO_UNREAD_POSTS_LOCKED'] : '{ NO_UNREAD_POSTS_LOCKED }')); ?></td>
				<td>&nbsp;&nbsp;</td>
