...
INSERT INTO `fleets` (`id`,`cargo`,`w_power`,`w_count`,`agrav`,`planet`,`star`,`hyper`,`mass`,`shield`,`user_id`,`arg1`,`arg2`,`place_id`,`place_type`,`name`) VALUES 
 (27,7500,0,0,1,0,0,0,12525,0,2,NULL,NULL,1,3,'Флот МШ4001-10'),
 (26,6000,0,0,1,0,0,0,10020,0,2,NULL,NULL,20002,1,'Флот МШ4001-1');
...
) ENGINE=MyISAM AUTO_INCREMENT=6302 DEFAULT CHARSET=utf8;
...
INSERT INTO `ships` (`id`,`object_id`,`place_id`,`place_type`,`user_id`,`name`,`arg1`,`arg2`,`fleet_id`) VALUES 
 (10001,4001,20002,1,2,'МШ4001-1',NULL,NULL,26),
 (10002,4001,20002,1,2,'МШ4001-2',NULL,NULL,26),
 (10003,4001,20002,1,2,'МШ4001-3',NULL,NULL,26),
 (10004,4001,20002,1,2,'МШ4001-4',NULL,NULL,26),
 (10008,4001,1,3,2,'МШ4001-8',NULL,NULL,27),
 (10007,4001,20002,0,2,'МШ4001-7',NULL,NULL,NULL),
 (10009,4001,20002,1,2,'МШ4001-9',NULL,NULL,NULL),
 (10010,4001,1,3,2,'МШ4001-10',NULL,NULL,27),
 (10011,4001,1,3,2,'МШ4001-11',NULL,NULL,27),
 (10012,4001,1,3,2,'МШ4001-12',NULL,NULL,27),
 (10013,4001,1,3,2,'МШ4001-13',NULL,NULL,27);
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','219ula4ms9nsj7fq4rlgs2cm25','2009-09-29 14:09:25','1',27,6);
...
) ENGINE=MyISAM AUTO_INCREMENT=14993 DEFAULT CHARSET=utf8;
...
INSERT INTO `users_messages` (`id`,`msg_date`,`to_user`,`from_user`,`text`) VALUES 
 ...
 (14986,'2009-09-23 06:25:51',2,1,'Изучение науки \'Скорочтение\' завершено успешно.'),
 (14987,'2009-09-25 00:32:35',2,1,'Переработка материала \'Касситерит\' на объекте с координатами 47,27 завершена успешно.'),
 (14988,'2009-09-25 00:32:50',2,1,'Переработка материала \'Вода\' на объекте с координатами 26,24 завершена успешно.'),
 (14989,'2009-09-28 12:19:14',2,1,'Переработка материала \'Турманит\' на объекте с координатами 26,24 завершена успешно.'),
 (14990,'2009-09-28 12:19:40',2,1,'Переработка материала \'Бадделеит\' на объекте с координатами 47,27 завершена успешно.'),
 (14991,'2009-09-28 12:41:52',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 44,27 завершены успешно.'),
 (14992,'2009-09-28 12:41:59',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 45,27 завершены успешно.');
...
INSERT INTO `warehouse` (`id`,`place_id`,`place_type`,`object_id`,`object_cnt`) VALUES 
 ...
 (389,8,6,1034,754),
 (388,8,6,1049,718),
 (385,20002,1,1030,16586),
 (715,20002,1,5060,60),
 (714,20002,1,5018,29),
 (378,20002,1,1013,2177),
 (377,20002,1,1037,697),
 (376,20002,1,1016,648),
 (403,20002,1,2002,5),
 (411,20002,1,6005,1),
 ...
 (510,20002,1,1045,108),
 (511,20002,1,1024,1625),
 (512,20002,1,1023,430),
 (513,20002,1,1002,65),
 ...
 (701,8,2,5018,1),
 (712,8,6,1014,1345),
 (716,20002,1,1019,290),
 (717,20002,1,1014,6),
 (726,20002,1,1004,91),
 (730,10010,2,1016,1500);
