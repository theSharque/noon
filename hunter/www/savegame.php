<?php
  ...
  if( auth() ) {
    if( isset( $_GET['gt'] ) && is_numeric( $_GET['gt'] ) &&
      ...
      db_query( "INSERT INTO games (    admin_id,  game_type,  start_type,  start_count,  victims_count,  end_type )
                            VALUES ( {$user['id']}, $game_type, $start_type, $start_count, $victims_count, $end_type )" );
