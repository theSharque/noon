...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','pai4nd6mpv92iipri9l77oer42','2009-09-18 12:54:52','1',1,2);
...
) ENGINE=MyISAM AUTO_INCREMENT=14739 DEFAULT CHARSET=utf8;
