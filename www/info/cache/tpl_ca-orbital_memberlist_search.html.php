...
<?php } ?>
	...
	<dl>
       <dt><label for="yahoo"><?php echo ((isset($this->_rootref['L_YIM'])) ? $this->_rootref['L_YIM'] : ((isset($user->lang['YIM'])) ? $user->lang['YIM'] : '{ YIM }')); ?>:</label></dt>
       <dd><input type="text" name="yahoo" id="yahoo" value="<?php echo (isset($this->_rootref['YAHOO'])) ? $this->_rootref['YAHOO'] : ''; ?>" class="inputbox" /></dd>
	</dl>
	<dl>
