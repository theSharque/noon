...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','cf2s90ri114qqqlasm7ctq8dq7','2009-08-19 00:45:36','1',1,1);
...
CREATE TABLE `users_messages` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2051 DEFAULT CHARSET=utf8;
