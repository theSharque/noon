...
<h2<?php if (! $this->_rootref['S_IS_BOT']) {  ?> class="leftside"<?php } ?>><a href="<?php echo (isset($this->_rootref['U_VIEW_FORUM'])) ? $this->_rootref['U_VIEW_FORUM'] : ''; ?>"><?php echo (isset($this->_rootref['FORUM_NAME'])) ? $this->_rootref['FORUM_NAME'] : ''; ?></a></h2>
...
<p class="rightside">
    <?php if ($this->_rootref['U_MCP']) {  ?>
        ...
        <?php $this->_tpldata['DEFINE']['.']['CA_TOPIC_LINKS'] = '1'; } if ($this->_rootref['S_WATCH_FORUM_LINK']) {  if ($this->_tpldata['DEFINE']['.']['CA_TOPIC_LINKS']) {  ?> &bull; <?php } else { $this->_tpldata['DEFINE']['.']['CA_TOPIC_LINKS'] = '1'; } ?>

        <a href="<?php echo (isset($this->_rootref['S_WATCH_FORUM_LINK'])) ? $this->_rootref['S_WATCH_FORUM_LINK'] : ''; ?>" title="<?php echo (isset($this->_rootref['S_WATCH_FORUM_TITLE'])) ? $this->_rootref['S_WATCH_FORUM_TITLE'] : ''; ?>"><?php echo (isset($this->_rootref['S_WATCH_FORUM_TITLE'])) ? $this->_rootref['S_WATCH_FORUM_TITLE'] : ''; ?></a>
    <?php } if ($this->_rootref['U_WATCH_TOPIC']) {  if ($this->_tpldata['DEFINE']['.']['CA_TOPIC_LINKS']) {  ?> &bull; <?php } else { $this->_tpldata['DEFINE']['.']['CA_TOPIC_LINKS'] = '1'; } ?>
    ...
    <?php } if ($this->_rootref['U_BOOKMARK_TOPIC']) {  if ($this->_tpldata['DEFINE']['.']['CA_TOPIC_LINKS']) {  ?> &bull; <?php } else { $this->_tpldata['DEFINE']['.']['CA_TOPIC_LINKS'] = '1'; } ?>

        <a href="<?php echo (isset($this->_rootref['U_BOOKMARK_TOPIC'])) ? $this->_rootref['U_BOOKMARK_TOPIC'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_BOOKMARK_TOPIC'])) ? $this->_rootref['L_BOOKMARK_TOPIC'] : ((isset($user->lang['BOOKMARK_TOPIC'])) ? $user->lang['BOOKMARK_TOPIC'] : '{ BOOKMARK_TOPIC }')); ?>"><?php echo ((isset($this->_rootref['L_BOOKMARK_TOPIC'])) ? $this->_rootref['L_BOOKMARK_TOPIC'] : ((isset($user->lang['BOOKMARK_TOPIC'])) ? $user->lang['BOOKMARK_TOPIC'] : '{ BOOKMARK_TOPIC }')); ?></a>
    <?php } if ($this->_rootref['U_BUMP_TOPIC']) {  if ($this->_tpldata['DEFINE']['.']['CA_TOPIC_LINKS']) {  ?> &bull; <?php } else { $this->_tpldata['DEFINE']['.']['CA_TOPIC_LINKS'] = '1'; } ?>

        <a href="<?php echo (isset($this->_rootref['U_BUMP_TOPIC'])) ? $this->_rootref['U_BUMP_TOPIC'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_BUMP_TOPIC'])) ? $this->_rootref['L_BUMP_TOPIC'] : ((isset($user->lang['BUMP_TOPIC'])) ? $user->lang['BUMP_TOPIC'] : '{ BUMP_TOPIC }')); ?>"><?php echo ((isset($this->_rootref['L_BUMP_TOPIC'])) ? $this->_rootref['L_BUMP_TOPIC'] : ((isset($user->lang['BUMP_TOPIC'])) ? $user->lang['BUMP_TOPIC'] : '{ BUMP_TOPIC }')); ?></a>
    <?php } ?>

</p>
<br clear="all" />
<?php } if ($this->_rootref['FORUM_DESC'] || $this->_rootref['MODERATORS']) {  ?>

<p>
	<?php if ($this->_rootref['FORUM_DESC']) {  echo (isset($this->_rootref['FORUM_DESC'])) ? $this->_rootref['FORUM_DESC'] : ''; ?><br /><?php } if ($this->_rootref['MODERATORS']) {  ?><p><strong><?php if ($this->_rootref['S_SINGLE_MODERATOR']) {  echo ((isset($this->_rootref['L_MODERATOR'])) ? $this->_rootref['L_MODERATOR'] : ((isset($user->lang['MODERATOR'])) ? $user->lang['MODERATOR'] : '{ MODERATOR }')); } else { echo ((isset($this->_rootref['L_MODERATORS'])) ? $this->_rootref['L_MODERATORS'] : ((isset($user->lang['MODERATORS'])) ? $user->lang['MODERATORS'] : '{ MODERATORS }')); } ?>:</strong> <?php echo (isset($this->_rootref['MODERATORS'])) ? $this->_rootref['MODERATORS'] : ''; ?></p><?php } ?>
...
<?php } if ($this->_rootref['S_NO_READ_ACCESS']) {  ?>
	...
	<?php if (! $this->_rootref['S_USER_LOGGED_IN'] && ! $this->_rootref['S_IS_BOT']) {  ?>
		...
		<div class="panel">
			<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_BLOCK2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_BLOCK2_START'] : ''; ?>
				...
				<a href="<?php echo (isset($this->_rootref['U_LOGIN_LOGOUT'])) ? $this->_rootref['U_LOGIN_LOGOUT'] : ''; ?>"><?php echo ((isset($this->_rootref['L_LOGIN_LOGOUT'])) ? $this->_rootref['L_LOGIN_LOGOUT'] : ((isset($user->lang['LOGIN_LOGOUT'])) ? $user->lang['LOGIN_LOGOUT'] : '{ LOGIN_LOGOUT }')); ?></a><?php if ($this->_rootref['S_REGISTER_ENABLED']) {  ?>&nbsp; &bull; &nbsp;<a href="<?php echo (isset($this->_rootref['U_REGISTER'])) ? $this->_rootref['U_REGISTER'] : ''; ?>"><?php echo ((isset($this->_rootref['L_REGISTER'])) ? $this->_rootref['L_REGISTER'] : ((isset($user->lang['REGISTER'])) ? $user->lang['REGISTER'] : '{ REGISTER }')); ?></a><?php } ?>
	...
	<?php } } $_topicrow_count = (isset($this->_tpldata['topicrow'])) ? sizeof($this->_tpldata['topicrow']) : 0;if ($_topicrow_count) {for ($_topicrow_i = 0; $_topicrow_i < $_topicrow_count; ++$_topicrow_i){$_topicrow_val = &$this->_tpldata['topicrow'][$_topicrow_i]; if (! $_topicrow_val['S_TOPIC_TYPE_SWITCH'] && ! $_topicrow_val['S_FIRST_ROW'] && $this->_tpldata['DEFINE']['.']['CA_TOPICS_SPLIT']) {  ?>

		</ul>
		<?php if ($this->_tpldata['DEFINE']['.']['CA_TOPIC_SWITCHED']) {  echo (isset($this->_tpldata['DEFINE']['.']['CA_BLOCK_END'])) ? $this->_tpldata['DEFINE']['.']['CA_BLOCK_END'] : ''; } else { echo (isset($this->_tpldata['DEFINE']['.']['CA_BLOCK2_END'])) ? $this->_tpldata['DEFINE']['.']['CA_BLOCK2_END'] : ''; } ?>

	</div>
	<?php } if ($_topicrow_val['S_FIRST_ROW'] || ! $_topicrow_val['S_TOPIC_TYPE_SWITCH']) {  if ($_topicrow_val['S_FIRST_ROW'] || $this->_tpldata['DEFINE']['.']['CA_TOPICS_SPLIT']) {  ?>

		<div class="forumbg<?php if ($_topicrow_val['S_TOPIC_TYPE_SWITCH']) {  ?> announcement<?php } ?>">
		<?php if ($_topicrow_val['S_FIRST_ROW']) {  ?>

            <?php echo (isset($this->_tpldata['DEFINE']['.']['CA_BLOCK2_START'])) ? $this->_tpldata['DEFINE']['.']['CA_BLOCK2_START'] : ''; ?>

                <h3><a href="<?php echo (isset($this->_rootref['U_VIEW_FORUM'])) ? $this->_rootref['U_VIEW_FORUM'] : ''; ?>"><?php echo (isset($this->_rootref['FORUM_NAME'])) ? $this->_rootref['FORUM_NAME'] : ''; ?></a></h3>
            <?php echo (isset($this->_tpldata['DEFINE']['.']['CA_BLOCK2_START2'])) ? $this->_tpldata['DEFINE']['.']['CA_BLOCK2_START2'] : ''; ?>
		...
		<?php } else { ?>
		    ...
		    <?php $this->_tpldata['DEFINE']['.']['CA_TOPIC_SWITCHED'] = '1'; } } ?>

		<ul class="topiclist">
			<li class="header<?php if (! $_topicrow_val['S_FIRST_ROW'] && ! $this->_tpldata['DEFINE']['.']['CA_TOPICS_SPLIT']) {  ?> header-inner<?php } ?>">
				<dl class="icon">
	...
	<?php } ?>
		...
		<li class="row<?php if (!($_topicrow_val['S_ROW_COUNT'] & 1)  ) {  ?> bg1<?php } else { ?> bg2<?php } if ($_topicrow_val['S_POST_ANNOUNCE']) {  ?> announce<?php } if ($_topicrow_val['S_POST_STICKY']) {  ?> sticky<?php } if ($_topicrow_val['S_TOPIC_REPORTED']) {  ?> reported<?php } if ($_topicrow_val['S_UNREAD_TOPIC']) {  ?> row-new<?php } ?>">
			<dl class="icon" style="background-image: url(<?php echo $_topicrow_val['TOPIC_FOLDER_IMG_SRC']; ?>); background-repeat: no-repeat;">
				...
				<dd class="lastpost"><span><dfn><?php echo ((isset($this->_rootref['L_LAST_POST'])) ? $this->_rootref['L_LAST_POST'] : ((isset($user->lang['LAST_POST'])) ? $user->lang['LAST_POST'] : '{ LAST_POST }')); ?> </dfn><?php echo ((isset($this->_rootref['L_POST_BY_AUTHOR'])) ? $this->_rootref['L_POST_BY_AUTHOR'] : ((isset($user->lang['POST_BY_AUTHOR'])) ? $user->lang['POST_BY_AUTHOR'] : '{ POST_BY_AUTHOR }')); ?> <?php echo $_topicrow_val['LAST_POST_AUTHOR_FULL']; ?>
					...
					<?php if (! $this->_rootref['S_IS_BOT']) {  ?><a href="<?php echo $_topicrow_val['U_LAST_POST']; ?>"><?php echo (isset($this->_rootref['LAST_POST_IMG'])) ? $this->_rootref['LAST_POST_IMG'] : ''; ?></a> <?php } ?><br /><?php echo $_topicrow_val['LAST_POST_TIME']; ?></span>				</dd>
			</dl>
		</li>
	...
	<form method="post" action="<?php echo (isset($this->_rootref['S_FORUM_ACTION'])) ? $this->_rootref['S_FORUM_ACTION'] : ''; ?>" id="topics-sort">
...
<?php } $this->_tpl_include('jumpbox.html'); if ($this->_rootref['S_DISPLAY_ONLINE_LIST']) {  ?>
    ...
    <?php echo (isset($this->_tpldata['DEFINE']['.']['CA_PANEL_START'])) ? $this->_tpldata['DEFINE']['.']['CA_PANEL_START'] : ''; ?>
	...
	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_PANEL_END'])) ? $this->_tpldata['DEFINE']['.']['CA_PANEL_END'] : ''; ?>
