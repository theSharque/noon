...
<h2<?php if ($this->_rootref['U_MCP']) {  ?> class="leftside"<?php } ?>><?php echo ((isset($this->_rootref['L_MCP'])) ? $this->_rootref['L_MCP'] : ((isset($user->lang['MCP'])) ? $user->lang['MCP'] : '{ MCP }')); ?></h2>

<?php if ($this->_rootref['U_MCP']) {  ?>
	<p class="linkmcp rightside">
	...
	<div id="cp-menu">
    	...
    	<?php echo (isset($this->_tpldata['DEFINE']['.']['CA_CP_BLOCK_START'])) ? $this->_tpldata['DEFINE']['.']['CA_CP_BLOCK_START'] : ''; ?>
			...
			<?php $_l_block1_count = (isset($this->_tpldata['l_block1'])) ? sizeof($this->_tpldata['l_block1']) : 0;if ($_l_block1_count) {for ($_l_block1_i = 0; $_l_block1_i < $_l_block1_count; ++$_l_block1_i){$_l_block1_val = &$this->_tpldata['l_block1'][$_l_block1_i]; if ($_l_block1_val['S_SELECTED']) {  ?>
				...
				<?php $_l_block2_count = (isset($_l_block1_val['l_block2'])) ? sizeof($_l_block1_val['l_block2']) : 0;if ($_l_block2_count) {for ($_l_block2_i = 0; $_l_block2_i < $_l_block2_count; ++$_l_block2_i){$_l_block2_val = &$_l_block1_val['l_block2'][$_l_block2_i]; if ($_l_block2_val['S_SELECTED']) {  ?>
	    			<li class="active-subsection"><div><a href="<?php echo $_l_block2_val['U_TITLE']; ?>"<?php if ($_l_block2_val['S_FIRST_ROW']) {  ?> class="first-row"<?php } else if ($_l_block2_val['S_LAST_ROW']) {  ?> class="last-row"<?php } ?>><span><?php echo $_l_block2_val['L_TITLE']; if ($_l_block2_val['ADD_ITEM']) {  ?> (<?php echo $_l_block2_val['ADD_ITEM']; ?>)<?php } ?></span></a></div></li>
				<?php } else { ?>
    				<li class="inactive-subsection"><div><a href="<?php echo $_l_block2_val['U_TITLE']; ?>"<?php if ($_l_block2_val['S_FIRST_ROW']) {  ?> class="first-row"<?php } else if ($_l_block2_val['S_LAST_ROW']) {  ?> class="last-row"<?php } ?>><span><?php echo $_l_block2_val['L_TITLE']; if ($_l_block2_val['ADD_ITEM']) {  ?> (<?php echo $_l_block2_val['ADD_ITEM']; ?>)<?php } ?></span></a></div></li>
				<?php } }} } else { ?>
