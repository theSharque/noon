...
CREATE TABLE `planet_events` (
  ...
  KEY `timers` USING BTREE (`event_time`,`event_type`),
  KEY `planet_timers` USING BTREE (`planet_id`,`event_time`,`event_type`)
...
INSERT INTO `planet_events` (`id`,`x`,`y`,`planet_id`,`object_id`,`event_time`,`event_type`) VALUES 
 (75,'5','1','1','23','2009-07-31 16:14:34',2);
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','ni2ecsvt9cuqbs51gcoia61ih2','2009-07-31 13:27:20','1',1,1);
