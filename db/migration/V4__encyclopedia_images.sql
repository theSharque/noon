...
UPDATE `enciclopedia` e
  INNER JOIN (
    ...
    SELECT 5012, 5 UNION ALL SELECT 5015, 6 UNION ALL SELECT 5019, 7 UNION ALL SELECT 5018, 8 UNION ALL SELECT 5060, 9 UNION ALL
    SELECT 5035, 0 UNION ALL SELECT 5002, 1 UNION ALL SELECT 5006, 2 UNION ALL SELECT 5011, 3 UNION ALL SELECT 5008, 4 UNION ALL
    SELECT 5020, 5 UNION ALL SELECT 5021, 6 UNION ALL SELECT 5043, 7 UNION ALL SELECT 5003, 8 UNION ALL SELECT 5027, 9 UNION ALL
    SELECT 5029, 0 UNION ALL SELECT 5038, 1 UNION ALL SELECT 5041, 2 UNION ALL SELECT 5039, 3 UNION ALL SELECT 5048, 4 UNION ALL
    SELECT 5058, 5 UNION ALL SELECT 5057, 6 UNION ALL SELECT 5034, 7 UNION ALL SELECT 5056, 8 UNION ALL SELECT 5044, 9
