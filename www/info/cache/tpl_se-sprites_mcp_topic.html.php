...
<div id="minitabs">
	<ul>
		...
		<li id="merge-panel-tab"<?php if ($this->_rootref['S_MERGE_VIEW']) {  ?> class="activetab"<?php } ?>>
			<span class="corners-top"><span></span></span>
			<a href="#minitabs" onclick="subPanels('merge-panel'); return false;"><span><?php echo ((isset($this->_rootref['L_MERGE_TOPIC'])) ? $this->_rootref['L_MERGE_TOPIC'] : ((isset($user->lang['MERGE_TOPIC'])) ? $user->lang['MERGE_TOPIC'] : '{ MERGE_TOPIC }')); ?></span></a>
		</li>
	</ul>
</div>
