...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`,`money`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','jbl3odoep8q1deab2c0s6fabn6','2009-10-27 20:01:30','1',10001,2,12000),
...
) ENGINE=MyISAM AUTO_INCREMENT=15908 DEFAULT CHARSET=utf8;
...
INSERT INTO `warehouse` (`id`,`place_id`,`place_type`,`object_id`,`object_cnt`) VALUES 
 ...
 (889,10001,2,1019,407),
 (887,10001,2,1044,438),
