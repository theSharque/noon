...
INSERT INTO `fleets` (`id`,`cargo`,`w_power`,`w_count`,`agrav`,`planet`,`hyper`,`mass`,`shield`,`user_id`,`arg1`,`arg2`,`place_id`,`place_type`,`name`,`planet_cnt`,`hyper_cnt`) VALUES 
 (71,15000,0,0,1,10,10,25050,0,2,NULL,NULL,1,3,'Флот МШ4001-10',10,10),
 (72,4500,0,0,1,10,10,7515,0,2,30,30,30001,7,'Флот МШ4001-10014',3,3);
...
CREATE TABLE `planets_mines` (
  ...
  `cycle` int(10) unsigned NOT NULL,
  PRIMARY KEY  (`event_id`)
) ENGINE=MyISAM AUTO_INCREMENT=7161 DEFAULT CHARSET=utf8;
...
INSERT INTO `ships` (`id`,`object_id`,`place_id`,`place_type`,`user_id`,`name`,`arg1`,`arg2`,`fleet_id`) VALUES 
 (10001,4001,11,3,2,'МШ4001-1',NULL,NULL,NULL),
 (10002,4001,1,3,2,'МШ4001-2',NULL,NULL,71),
 (10003,4001,1,3,2,'МШ4001-3',NULL,NULL,71),
 (10004,4001,1,3,2,'МШ4001-4',NULL,NULL,71),
 (10008,4001,1,3,2,'МШ4001-8',NULL,NULL,71),
 (10007,4001,1,3,2,'МШ4001-7',NULL,NULL,71),
 (10009,4001,1,3,2,'МШ4001-9',NULL,NULL,71),
 (10010,4001,1,3,2,'МШ4001-10',NULL,NULL,71),
 (10011,4001,1,3,2,'МШ4001-11',NULL,NULL,71),
 (10012,4001,1,3,2,'МШ4001-12',NULL,NULL,71),
 (10013,4001,1,3,2,'МШ4001-13',NULL,NULL,71),
 (10016,4001,30001,7,2,'МШ4001-10016',30,30,72),
 (10015,4001,30001,7,2,'МШ4001-10015',30,30,72),
 (10014,4001,30001,7,2,'МШ4001-10014',30,30,72);
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`,`money`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','85m392koc8vpect2tfk83q1881','2009-10-27 14:47:55','1',10001,2,12000),
...
) ENGINE=MyISAM AUTO_INCREMENT=15902 DEFAULT CHARSET=utf8;
...
INSERT INTO `users_messages` (`id`,`msg_date`,`to_user`,`from_user`,`text`) VALUES 
 (15860,'2009-10-27 13:16:15',2,1,'Перелет флота \'Флот МШ4001-1\' к звезде Сонтару завершен успешно.'),
 (15861,'2009-10-27 13:17:32',2,1,'Перелет флота \'Флот МШ4001-1\' к планете Сааракш завершен успешно.'),
 (15862,'2009-10-27 14:46:18',2,1,'Строительство объекта \'Солнечная электростанция\' в точке стояния 8 завершено успешно.'),
 (15863,'2009-10-27 14:50:48',2,1,'Переработка материала \'Кварц\' на объекте с координатами 26,24 завершена успешно.'),
 (15864,'2009-10-27 14:57:06',2,1,'Строительство объекта \'Орб. сборочный цех\' в точке стояния 6 завершено успешно.'),
 (15865,'2009-10-27 15:01:22',2,1,'Переработка материала \'Гематит\' на объекте с координатами 47,27 завершена успешно.'),
 (15866,'2009-10-27 15:13:25',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 44,27 завершены успешно.'),
 (15867,'2009-10-27 15:13:28',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 45,27 завершены успешно.'),
 (15868,'2009-10-27 15:13:31',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 46,27 завершены успешно.'),
 (15869,'2009-10-27 15:13:33',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 44,28 завершены успешно.'),
 (15870,'2009-10-27 15:13:47',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 45,28 завершены успешно.'),
 (15871,'2009-10-27 15:13:50',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 46,28 завершены успешно.'),
 (15872,'2009-10-27 15:13:53',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 47,28 завершены успешно.'),
 (15873,'2009-10-27 15:13:57',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 48,28 завершены успешно.'),
 (15874,'2009-10-27 15:22:40',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 49,28 завершены успешно.'),
 (15875,'2009-10-27 15:22:43',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 44,29 завершены успешно.'),
 (15876,'2009-10-27 15:22:46',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 45,29 завершены успешно.'),
 (15877,'2009-10-27 15:22:49',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 46,29 завершены успешно.'),
 (15878,'2009-10-27 15:22:53',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 47,29 завершены успешно.'),
 (15879,'2009-10-27 15:22:56',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 48,29 завершены успешно.'),
 (15880,'2009-10-27 15:22:59',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 49,29 завершены успешно.'),
 (15881,'2009-10-27 15:23:02',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 44,30 завершены успешно.'),
 (15882,'2009-10-27 15:23:06',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 45,30 завершены успешно.'),
 (15883,'2009-10-27 15:23:11',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 46,30 завершены успешно.'),
 (15884,'2009-10-27 15:23:14',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 47,30 завершены успешно.'),
 (15885,'2009-10-27 15:23:19',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 48,30 завершены успешно.'),
 (15886,'2009-10-27 15:23:22',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 49,30 завершены успешно.'),
 (15887,'2009-10-27 15:23:26',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 44,31 завершены успешно.'),
 (15888,'2009-10-27 15:23:30',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 45,31 завершены успешно.'),
 (15889,'2009-10-27 15:23:33',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 46,31 завершены успешно.'),
 (15890,'2009-10-27 15:23:36',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 47,31 завершены успешно.'),
 (15891,'2009-10-27 15:23:40',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 48,31 завершены успешно.'),
 (15892,'2009-10-27 15:23:43',2,1,'Циклы добычи материала \'Гематит\' на объекте с координатами 49,31 завершены успешно.'),
 (15893,'2009-10-27 15:35:02',2,1,'Усовершенствование объекта \'Орб. сборочный цех\' в точке стояния 6 завершено успешно.'),
 (15894,'2009-10-27 16:11:58',2,1,'Изготовление объекта \'Малый шатл\' в орбитальном сборочном цехе с координатами 6 завершено успешно.'),
 (15895,'2009-10-27 16:14:37',2,1,'Изготовление объекта \'Малый шатл\' в орбитальном сборочном цехе с координатами 6 завершено успешно.'),
 (15896,'2009-10-27 16:24:37',2,1,'Изготовление объекта \'Малый шатл\' в орбитальном сборочном цехе с координатами 6 завершено успешно.'),
 (15897,'2009-10-27 16:30:54',2,1,'Перелет флота \'Флот МШ4001-10014\' к звезде Тевосами завершен успешно.'),
 (15898,'2009-10-27 16:31:16',2,1,'Переработка материала \'Гематит\' на объекте с координатами 47,27 завершена успешно.'),
 (15899,'2009-10-27 16:31:53',2,1,'Перелет корабля \'МШ4001-1\' к звезде Тевосами завершен успешно.'),
 (15900,'2009-10-27 16:33:36',2,1,'Перелет флота \'Флот МШ4001-10014\' к звезде Сонтару завершен успешно.'),
 (15901,'2009-10-27 16:33:45',2,1,'Перелет корабля \'МШ4001-1\' к планете Перюфами завершен успешно.');
...
INSERT INTO `warehouse` (`id`,`place_id`,`place_type`,`object_id`,`object_cnt`) VALUES 
 ...
 (413,20002,0,2005,2),
 (415,20002,1,4001,11),
 (941,20002,1,1037,331),
 (419,20002,1,1048,1140),
 (937,20002,0,1039,1302),
 (443,20002,0,2004,3),
 (442,20002,0,2003,4),
 (939,10010,2,1019,1500),
 (592,20002,1,7001,1),
 (769,20002,0,1037,1182),
 (944,20002,1,1016,1656),
 ...
 (610,20002,0,1043,5000),
 (895,20002,0,1019,7500),
 ...
 (889,10001,2,1019,440),
 (887,10001,2,1044,439),
 (888,20002,0,1049,230),
 (891,20002,0,1030,423),
 (892,20002,0,1033,125),
 (893,20002,0,1046,574),
 (894,20002,0,1028,125),
 (896,20002,0,1047,28),
 (897,20002,0,1009,4),
 (898,20002,0,1014,124),
