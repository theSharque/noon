...
INSERT INTO `planet_events` (`id`,`x`,`y`,`planet_id`,`object_id`,`event_time`,`event_type`,`timer`,`user_id`) VALUES 
 (5955,26,26,2,37,'2009-09-15 17:30:12',2,300,2);
...
CREATE TABLE `planets_make` (
  ...
  PRIMARY KEY  (`event_id`)
) ENGINE=MyISAM AUTO_INCREMENT=5744 DEFAULT CHARSET=utf8;
...
CREATE TABLE `planets_mines` (
  ...
  `cycle` int(10) unsigned NOT NULL,
  PRIMARY KEY  (`event_id`)
) ENGINE=MyISAM AUTO_INCREMENT=5956 DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','uekbsn9q6ve3pmkdo0fo8dmag6','2009-09-15 11:18:02','1',1,2);
...
) ENGINE=MyISAM AUTO_INCREMENT=14636 DEFAULT CHARSET=utf8;
