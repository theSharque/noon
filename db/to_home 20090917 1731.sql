...
INSERT INTO `buildings` (`id`,`desc`,`energy`,`warehouse`,`map_char`,`req_id`) VALUES 
 ...
 (3003,'Позволяет исследовать полностью поверхность планеты, каждое новое улучшение позволяет исследовать очередной слой.',-500,0,'G',NULL),
 (3002,'Добывает колосальное количество энергии преобразуя свободную солнечную энергию электричество. Из за отсутсвия гравитации солнечные панели распространяются на несколько километров вокруг спутника.',1000,0,'A',NULL);
...
INSERT INTO `ships` (`id`,`object_id`,`place_id`,`place_type`,`user_id`,`name`,`rad`,`len`) VALUES 
 ...
 (10,4001,2,1,2,'МШ4001-10',NULL,NULL),
 (11,4001,2,1,2,'МШ4001-11',NULL,NULL),
 (12,4001,2,1,2,'МШ4001-12',NULL,NULL),
 (13,4001,2,1,2,'МШ4001-13',NULL,NULL);
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','39heci79f2l4gmk3c9g9v7h0j1','2009-09-17 14:54:11','1',1,2);
