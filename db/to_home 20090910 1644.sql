...
) ENGINE=MyISAM AUTO_INCREMENT=4280 DEFAULT CHARSET=utf8;
...
CREATE TABLE `planets_mines` (
  ...
  PRIMARY KEY  (`event_id`)
) ENGINE=MyISAM AUTO_INCREMENT=4276 DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','mb2n424h6m53so5kr7fkf71253','2009-09-10 15:56:16','1',2,1);
...
) ENGINE=MyISAM AUTO_INCREMENT=11956 DEFAULT CHARSET=utf8;
