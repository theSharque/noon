...
INSERT INTO `fleets` (`id`,`cargo`,`w_power`,`w_count`,`agrav`,`planet`,`star`,`hyper`,`mass`,`shield`,`user_id`,`arg1`,`arg2`,`place_id`,`place_type`,`name`) VALUES 
 (2,1500,0,0,1,0,0,0,2505,0,2,NULL,NULL,20002,1,'Флот МШ4001-4'),
 (3,3000,0,0,1,0,0,0,5010,0,2,NULL,NULL,20002,1,'Флот МШ4001-12');
...
CREATE TABLE `ships` (
  ...
  `object_id` int(10) unsigned NOT NULL,
  `place_id` int(10) unsigned NOT NULL,
  `place_type` int(10) unsigned NOT NULL COMMENT '0-orbit, 1-planet, 2-ship, 3-station, 5-in fly, 6-in fleet',
  `user_id` int(10) unsigned default NULL,
...
INSERT INTO `ships` (`id`,`object_id`,`place_id`,`place_type`,`user_id`,`name`,`arg1`,`arg2`) VALUES 
 (10001,4001,0,6,2,'МШ4001-1',NULL,NULL),
 (10002,4001,20002,1,2,'МШ4001-2',NULL,NULL),
 (10003,4001,20002,1,2,'МШ4001-3',NULL,NULL),
 (10004,4001,2,6,2,'МШ4001-4',NULL,NULL),
 (10008,4001,0,6,2,'МШ4001-8',NULL,NULL),
 (10007,4001,2,6,2,'МШ4001-7',NULL,NULL),
 (10009,4001,0,6,2,'МШ4001-9',NULL,NULL),
 (10010,4001,1,3,2,'МШ4001-10',NULL,NULL),
 (10011,4001,20002,0,2,'МШ4001-11',NULL,NULL),
 (10012,4001,3,6,2,'МШ4001-12',NULL,NULL),
 (10013,4001,3,6,2,'МШ4001-13',NULL,NULL);
...
CREATE TABLE `users` (
  ...
  `place_type` int(10) unsigned NOT NULL COMMENT '0-orbit, 1-planet, 2-ship, 3-station, 4-star, 5-in fly, 6-in fleet',
  PRIMARY KEY  (`id`),
  KEY `by_ssid` (`ssid`),
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','ih4alfas0je41cbh6ml8sroam2','2009-09-23 12:14:30','1',20002,1);
...
) ENGINE=MyISAM AUTO_INCREMENT=14987 DEFAULT CHARSET=utf8;
