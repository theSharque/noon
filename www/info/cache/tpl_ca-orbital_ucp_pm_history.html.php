...
<div id="topicreview">
	...
	<div class="post <?php if (!($_history_row_val['S_ROW_COUNT'] & 1)  ) {  ?>bg1<?php } else { ?>bg2<?php } ?>">
		...
		<div class="postbody" id="pr<?php echo $_history_row_val['MSG_ID']; ?>">
			...
			<div class="content<?php if ($_history_row_val['S_CURRENT_MSG']) {  ?> current<?php } ?>"><?php echo $_history_row_val['MESSAGE']; ?></div>
			...
			<ul class="profile-icons">
				<li class="quote-icon"><a <?php if ($_history_row_val['U_QUOTE']) {  ?>href="<?php echo $_history_row_val['U_QUOTE']; ?>"<?php } else { ?>href="#postingbox" onclick="addquote(<?php echo $_history_row_val['MSG_ID']; ?>, '<?php echo $_history_row_val['MESSAGE_AUTHOR_QUOTE']; ?>');"<?php } ?> title="<?php echo ((isset($this->_rootref['L_QUOTE'])) ? $this->_rootref['L_QUOTE'] : ((isset($user->lang['QUOTE'])) ? $user->lang['QUOTE'] : '{ QUOTE }')); ?> <?php echo $_history_row_val['MESSAGE_AUTHOR']; ?>"><span><?php echo ((isset($this->_rootref['L_QUOTE'])) ? $this->_rootref['L_QUOTE'] : ((isset($user->lang['QUOTE'])) ? $user->lang['QUOTE'] : '{ QUOTE }')); ?> <?php echo $_history_row_val['MESSAGE_AUTHOR']; ?></span></a></li>
			</ul>
			<?php } ?>
            <div class="clear"></div>
		</div>
