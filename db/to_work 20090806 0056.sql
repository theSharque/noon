...
INSERT INTO `objects` (`id`,`name`,`min_cnt`,`mass`,`class`,`price`,`weight`) VALUES 
 ...
 (4,'Кварц_old',1,1,1,0,0),
 (5,'Мышьяк',1,1,1,0,0),
 (6,'Уран',1,1,1,0,0),
 (7,'Сера',1,1,1,0,0),
 (8,'Дерево',1,1,1,0,0),
 (9,'Вода_old',100,1,5,0,0),
 (10,'Никель',1,1,1,0,0),
 (11,'Медь',1,1,1,0,0),
 (12,'Золото',1,1,1,0,0),
 (13,'Титан',1,1,1,0,0),
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','78qk9i2ginkeabtih42l8g8bl4','2009-08-05 23:10:37','1',1,1);
