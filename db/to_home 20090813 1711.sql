...
INSERT INTO `books` (`id`,`name`,`description`,`parent_id`,`parent_level`,`teach_time`) VALUES 
 (1,'Математика','Основы алгебры и геометрии, знания помогают в торговле, навигации и необходимы для понимания основ программирования.',NULL,NULL,60),
 (2,'Физика','Проведение простых экспериментов, основы физических процессов. Знания позволяют изучить металлургию, а так же открывают путь к сложному оружию. Понимание физики процессов позволит строить более совершенные реакторы, вырабатывать больше енергии.',NULL,NULL,120),
 (3,'Металургия','Переплавка метала, обработка металла. Знание позволяет эффективнее и быстрее добывать сырье. Полученные навыки дают приемущиство для разработки крупных месторождений.',2,3,240),
 (4,'Навигация','Управление космическим кораблем, настройка навигационного компьютера',1,3,1200),
 (5,'Гипернавигация','Управление космическим кораблем в гиперпространстве, прокладка оптимального маршрута',4,5,180),
 (6,'Шахтерство','Разработка месторождений на метеоритах, метрвых планетах, добыча газов с планет гигантов',3,3,180),
 (7,'Программирование','Переобучение компьютера, возможность установки имплантантов',1,5,180),
 (8,'Лазерное оружие','Владение лазерным оружием',2,4,180),
 (9,'Плазменное оружие','Владение плазменным оружием',2,4,180),
 (10,'Ракетное оружие','Владение ракетным оружием',2,4,180);
...
CREATE TABLE `planets_buildings` (
  ...
  PRIMARY KEY  (`id`),
  UNIQUE KEY `by_x_y` USING BTREE (`x`,`y`,`planet_id`),
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','7uelejoas5ouojjee4u4if1100','2009-08-13 12:17:59','1',1,1);
...
INSERT INTO `users_messages` (`id`,`msg_date`,`to_user`,`from_user`,`text`) VALUES 
 (17,'2009-08-13 16:32:53',2,1,'Цикл добычи материала Гематит на объекте с координатами 4,1 завершено успешно.'),
 (16,'2009-08-13 16:32:53',2,1,'Цикл добычи материала Гематит на объекте с координатами 4,1 завершено успешно.'),
 (3,'2009-08-13 14:08:01',2,1,'Изучение Физика завершено успешно.'),
 (4,'2009-08-13 14:16:23',2,1,'Строительство Карьер с координатами 7,1 завершено успешно.'),
 (5,'2009-08-13 14:39:34',2,1,'Усовершенствование объекта Карьер с координатами 3,3 завершено успешно.'),
 (6,'2009-08-13 14:45:06',2,1,'Цикл добычи материала Гематит на объекте с координатами 4,1 завершено успешно.'),
 (18,'2009-08-13 16:32:53',2,1,'Цикл добычи материала Гематит на объекте с координатами 4,1 завершено успешно.'),
 (19,'2009-08-13 16:32:53',2,1,'Цикл добычи материала Гематит на объекте с координатами 4,1 завершено успешно.'),
 (20,'2009-08-13 16:32:53',2,1,'Цикл добычи материала Гематит на объекте с координатами 4,1 завершено успешно.'),
 (21,'2009-08-13 17:10:32',2,1,'Переработка материала Альбит на объекте с координатами 4,3 завершено успешно.');
