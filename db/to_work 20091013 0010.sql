...
INSERT INTO `fleets` (`id`,`cargo`,`w_power`,`w_count`,`agrav`,`planet`,`star`,`hyper`,`mass`,`shield`,`user_id`,`arg1`,`arg2`,`place_id`,`place_type`,`name`) VALUES 
 (35,7500,0,0,1,10,0,0,12525,0,2,NULL,NULL,20002,1,'Флот МШ4001-1');
...
INSERT INTO `ship_types` (`object_id`,`agrav`,`planet`,`star`,`hyper`,`shield`,`cargo`,`w_power`,`w_count`,`code`) VALUES 
 (4001,1,10,0,0,0,1500,0,0,'МШ4001');
...
INSERT INTO `ships` (`id`,`object_id`,`place_id`,`place_type`,`user_id`,`name`,`arg1`,`arg2`,`fleet_id`) VALUES 
 (10001,4001,20002,1,2,'МШ4001-1',NULL,NULL,35),
 (10002,4001,20002,1,2,'МШ4001-2',NULL,NULL,NULL),
 (10003,4001,20002,0,2,'МШ4001-3',NULL,NULL,NULL),
 (10004,4001,20002,0,2,'МШ4001-4',NULL,NULL,NULL),
 (10008,4001,20002,1,2,'МШ4001-8',NULL,NULL,NULL),
 (10007,4001,20002,0,2,'МШ4001-7',NULL,NULL,NULL),
 (10009,4001,20001,0,2,'МШ4001-9',NULL,NULL,NULL),
 (10010,4001,20002,1,2,'МШ4001-10',NULL,NULL,35),
 (10011,4001,20002,1,2,'МШ4001-11',NULL,NULL,35),
 (10012,4001,20002,1,2,'МШ4001-12',NULL,NULL,35),
 (10013,4001,20002,1,2,'МШ4001-13',NULL,NULL,35);
...
CREATE TABLE `space_events` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `event_type` int(10) unsigned NOT NULL COMMENT '0-land ship,1-flyout ship, 100-land fleet, 101-flyout fleet,2-fly ship to point, 102-fly fleet to point, 3-fly ship to planet, 103-fly fleet to point',
...
INSERT INTO `space_events` (`id`,`event_type`,`ship_id`,`event_time`,`timer`,`user_id`,`arg1`,`arg2`) VALUES 
 (123,2,10003,'2009-10-12 23:46:54',22,2,207,272),
 (120,3,10003,'2009-10-12 23:45:39',11,2,0,20001),
 (122,3,10004,'2009-10-12 23:46:31',11,2,0,20001);
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','8p3b2pkih2muuqc6jl53ms7g04','2009-10-12 20:08:51','1',35,6);
...
INSERT INTO `warehouse` (`id`,`place_id`,`place_type`,`object_id`,`object_cnt`) VALUES 
 ...
 (813,20002,1,5039,10),
 (814,20002,1,5028,20),
 (815,10003,2,1019,1500),
 (816,10004,2,1019,1024);
