...
<?php
  ...
  $res = db_fetch_array( "SELECT fid, galery, referer, get_from FROM files ORDER BY date_upload desc LIMIT $start,180" );
  ...
  echo '</table>';
  echo '<a href="show_me_all.php?st='.($start + 180).'">Next</a>';
?>
</body>
</html>