...
INSERT INTO `fleets` (`id`,`cargo`,`w_power`,`w_count`,`agrav`,`planet`,`star`,`hyper`,`mass`,`shield`,`user_id`,`arg1`,`arg2`,`place_id`,`place_type`,`name`) VALUES 
 (25,6000,0,0,1,0,0,0,10020,0,2,NULL,NULL,1,3,'Флот МШ4001-10'),
...
) ENGINE=MyISAM AUTO_INCREMENT=6298 DEFAULT CHARSET=utf8;
...
INSERT INTO `planets` (`id`,`type`,`name`,`user_id`,`last_pos`,`star_id`,`planet_pos`) VALUES 
 ...
 (20002,1,'Сааракш',2,'45:26',30001,5);
...
INSERT INTO `ships` (`id`,`object_id`,`place_id`,`place_type`,`user_id`,`name`,`arg1`,`arg2`,`fleet_id`) VALUES 
 ...
 (10010,4001,1,3,2,'МШ4001-10',NULL,NULL,25),
 (10011,4001,1,3,2,'МШ4001-11',NULL,NULL,25),
 (10012,4001,1,3,2,'МШ4001-12',NULL,NULL,25),
 (10013,4001,1,3,2,'МШ4001-13',NULL,NULL,25);
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','npemrvjr232i5amomm62keov30','2009-09-25 16:54:59','1',20002,1);
...
) ENGINE=MyISAM AUTO_INCREMENT=14989 DEFAULT CHARSET=utf8;
