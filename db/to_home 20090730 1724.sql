...
INSERT INTO `buildings` (`id`,`desc`,`build_time`,`energy`,`warehouse`,`map_char`,`req_id`) VALUES 
 (23,'Позволяет добывать ресурсы с поверхности планеты.',1,-10,1000,'K',34),
 (24,'Переплавляет первичные ресурсы, и ненужные устройства.',2,-15,1000,'P',34),
 (25,'Позволяет исследовать агрегаты, устройства, природные процессы',3,-35,500,'L',39),
 (26,'Изначальная структура в которой вы спустились на планету. Обладает возможностью полностью регенирировать игрока и восстанавливать память.',0,50,5000,'C',NULL),
 (33,'Позволяет изготавливать вещи при наличии чертежа и ресурсов',1,-50,5000,'F',24),
 (34,'Вырабатывает электроэнергию необходимую всем постройкам на планете, без энергии не функционируют устройства',1,100,0,'E',NULL),
 (36,'Позволяет добывать ресурсы из под поверхности планеты.',2,-30,1000,'M',34),
 (37,'Позволяет добывать ресурсы из глубины планеты.',4,-60,1000,'O',34),
 (38,'Позволяет хранить больше товара на планете',5,-10,50000,'S',24),
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','m3aojg4t7fk68odnoe5pn59kc7','2009-07-30 11:24:49','1',1,1);
