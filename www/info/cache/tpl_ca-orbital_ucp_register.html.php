<?php if (!defined('IN_PHPBB')) exit; $this->_tpldata['DEFINE']['.']['CA_PAGE'] = 'register'; $this->_tpl_include('overall_header.html'); ?>
...
<div class="panel">
	...
	<dl>
		...
		<dd><select style="max-width: 250px;" name="tz" id="tz" tabindex="7" class="autowidth"><?php echo (isset($this->_rootref['S_TZ_OPTIONS'])) ? $this->_rootref['S_TZ_OPTIONS'] : ''; ?></select></dd>
	</dl>
...
<div class="panel">
	...
	<fieldset class="submit-buttons">
		...
		<input type="submit" name="submit" id="submit" value="<?php echo ((isset($this->_rootref['L_SUBMIT'])) ? $this->_rootref['L_SUBMIT'] : ((isset($user->lang['SUBMIT'])) ? $user->lang['SUBMIT'] : '{ SUBMIT }')); ?>" class="button1  default-submit-action" tabindex="9"/>
