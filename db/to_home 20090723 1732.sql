...
INSERT INTO `buildings` (`id`,`desc`,`build_time`,`energy`,`warehouse`,`map_char`) VALUES 
 (23,'Позволяет добывать ресурсы с поверхности планеты.',1,-10,1000,'K'),
 (24,'Переплавляет первичные ресурсы, и ненужные устройства.',2,-15,1000,'P'),
 (25,'Позволяет исследовать агрегаты, устройства, природные процессы',3,-35,500,'L'),
 (26,'Изначальная структура в которой вы спустились на планету. Обладает возможностью полностью регенирировать игрока и восстанавливать память.',0,50,5000,'C'),
 (33,'Позволяет изготавливать вещи при наличии чертежа и ресурсов',1,-50,5000,'F'),
 (34,'Вырабатывает электроэнергию необходимую всем постройкам на планете, без энергии не функционируют устройства',1,100,0,'E'),
 (36,'Позволяет добывать ресурсы из под поверхности планеты.',2,-30,1000,'M'),
 (37,'Позволяет добывать ресурсы из глубины планеты.',4,-60,1000,'O'),
 (38,'Позволяет хранить больше товара на планете',5,-10,50000,'S'),
 (39,'Позволяет изготавливать сложные устройства, собираемые из нескольких модулей.',7,-70,5000,'R');
...
CREATE TABLE `planet_events` (
  ...
  `planet_id` varchar(45) NOT NULL,
  `object_id` varchar(45) NOT NULL,
  `event_time` datetime NOT NULL,
  PRIMARY KEY  (`id`),
  KEY `planet_x_y` (`planet_id`,`x`,`y`),
  KEY `timers` (`event_time`),
  KEY `planet_timers` (`planet_id`,`event_time`),
...
INSERT INTO `planet_events` (`id`,`x`,`y`,`planet_id`,`object_id`,`event_time`) VALUES 
 (21,'2','1','1','37','2009-07-23 17:02:51'),
 (20,'7','1','1','37','2009-07-23 17:02:39');
...
INSERT INTO `planets_buildings` (`id`,`object_id`,`planet_id`) VALUES 
 (1,26,1),
 (2,23,1),
 (3,23,1),
 (4,36,1),
...
INSERT INTO `users` (`id`,`login`,`password`,`firstname`,`lastname`,`email`,`ssid`,`lastlogin`,`status`,`place_id`,`place_type`) VALUES 
 ...
 (2,'admin','827ccb0eea8a706c4c34a16891f84e7b','admin','admin','admin@localhost','b68sda4ghsk7d80j8s6k3cbb01','2009-07-23 12:58:31','1',1,1);
